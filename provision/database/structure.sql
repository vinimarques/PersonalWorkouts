...
CREATE TABLE IF NOT EXISTS `personalworkouts`.`day_exercise` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_day_exercise_exercise_group1_idx` (`exercise_group_id` ASC),
  CONSTRAINT `fk_day_exercise_exercise_group1`
    FOREIGN KEY (`exercise_group_id`)
    REFERENCES `personalworkouts`.`exercise_group` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
